//
//  JKLABTuneSelectionTableViewController.m
//  taiko
//
...
@interface JKLABTuneSelectionTableViewController ()
@property(nonatomic, retain) NSDictionary *tuneData;
@end

@implementation JKLABTuneSelectionTableViewController

@synthesize tuneData;
@synthesize tuneKeyToConfigure;
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    NSUInteger n = [[tuneData allKeys] count];
    return n;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [JKLABUserConfig setValue:tuneKey WithKey:tuneKeyToConfigure];
